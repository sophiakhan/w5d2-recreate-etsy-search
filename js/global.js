...
function searchFor() {
    var searchKeyword = document.getElementById('#searchInput').addEventListener('onkeypress', innerHTML.value);
}

var searchClick = document.querySelector('#search-button').addEventListener("click", searchFor);





// window.addEventListener('onkeypress', searchFor() {
